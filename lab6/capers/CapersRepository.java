...
public class CapersRepository {
    ...
    static final File STORY_FILE = join(".capers", "story");
    // function in Utils
    ...
    public static void writeStory(String text) {
        // TODO
        String story_text = readContentsAsString(STORY_FILE) + text + "\n";
        writeContents(STORY_FILE, story_text);
        System.out.println(story_text);
    }
